...
class Admin::BlogsControllerTest < ActionController::TestCase
  ...
  test "should create admin_blog" do
    assert_difference('Admin::Blog.count') do
      post :create, admin_blog: { active: @admin_blog.active, has_comments: @admin_blog.has_comments, num_comments: @admin_blog.num_comments, post: @admin_blog.post, slug: @admin_blog.slug, spost: @admin_blog.spost, status: @admin_blog.status, title: @admin_blog.title }
    end
  ...
  test "should update admin_blog" do
    put :update, id: @admin_blog, admin_blog: { active: @admin_blog.active, has_comments: @admin_blog.has_comments, num_comments: @admin_blog.num_comments, post: @admin_blog.post, slug: @admin_blog.slug, spost: @admin_blog.spost, status: @admin_blog.status, title: @admin_blog.title }
    assert_redirected_to admin_blog_path(assigns(:admin_blog))
  end
