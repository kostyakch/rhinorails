...
class Admin::GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create admin_gallery" do
    assert_difference('Admin::Gallery.count') do
      post :create, admin_gallery: { active: @admin_gallery.active, descr: @admin_gallery.descr, name: @admin_gallery.name, url: @admin_gallery.url }
    end
  ...
  test "should update admin_gallery" do
    put :update, id: @admin_gallery, admin_gallery: { active: @admin_gallery.active, descr: @admin_gallery.descr, name: @admin_gallery.name, url: @admin_gallery.url }
    assert_redirected_to admin_gallery_path(assigns(:admin_gallery))
  end
